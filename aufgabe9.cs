...
namespace Fusee.Tutorial.Core
{
	...
	public class HierarchyInput : RenderCanvas
    {
        ...
        public override void RenderAFrame()
        {
            ...
            float bluearm = _ArmTransform.Rotation.x;
            bluearm += 0.05f * Keyboard.WSAxis;
            _ArmTransform.Rotation = new float3(bluearm, 0, 0);

            float bluearm1 = _Arm2Transform.Rotation.x;
            bluearm1 += 0.05f * Keyboard.ADAxis;
            _Arm2Transform.Rotation = new float3(bluearm1, 0, 0);
			...
			// Setup the camera 
            RC.View = float4x4.CreateTranslation(0, -20, 55) * float4x4.CreateRotationY(_camAngle);
